...
const INDUSTRIES = [
  {
    ...
    description:
      "Precision tracking for high-value machinery. Protect multi-million dollar investments with surgical control.",
    icon: HardHat,
    items: [
      "Engine Hour Intelligence",
      "Theft Prevention Layer",
  ...
  },
  {
    ...
    description:
      "The backbone of global supply chains. AI-powered route optimization and driver safety compliance.",
    icon: Truck,
    items: [
  ...
  },
  {
    ...
    description:
      "Reliability is mission-critical. Coordinate field technical teams with absolute geographic accuracy.",
    icon: Wrench,
    items: [
      "Dynamic Field Dispatch",
      "Technician ETA Logic",
  ...
  },
  {
    ...
    description:
      "Uncompromising accountability and operational transparency for government and emergency fleets.",
    icon: ShieldCheck,
    items: [
      "Audit-grade Reporting",
      "Fleet Lifecycle Care",
      "Fuel Waste Mitigation",
...
const SHOWCASE_FEATURES = [
  {
    ...
    description:
      "Our proprietary hardware-to-cloud stack delivers high-fidelity data from the world's most demanding environments. Every engine start, every vibration, every liter of fuel—monitored in real-time.",
  ...
  },
  {
    ...
    description:
      "Move beyond simple GPS. FleetNET captures complex vehicle CAN-bus data to provide a digital twin of your entire mobile operation. Predict failures before they occur.",
  ...
  },
  {
    ...
    description:
      "Transform your safety culture with AI-driven scoring. Monitor G-force events, acceleration patterns, and fatigue indicators to protect your most valuable assets: your people.",
...
const EXPANSION_CARDS = [
  {
    ...
    description:
      "Service fleets for power, water, and telecom networks requiring 100% uptime.",
    icon: Cpu,
  },
  {
    title: "Urban Transit",
    description:
      "Real-time depot analytics and route adherence for large-scale public transportation.",
    icon: Building2,
  },
  {
    title: "Healthcare Logistics",
    description:
      "Chain-of-custody for pharmaceutical distribution and temperature-controlled medical cargo.",
    icon: Users,
  },
];
          ...
          <div className="flex-1 max-w-xl">
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-primary font-black uppercase tracking-[0.4em] text-xs leading-none">
                  {feature.subtitle}
                </span>
              </div>
      ...
      <section className="relative z-10 py-32 bg-[#050505]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mb-24">
            <span className="text-primary font-black uppercase tracking-[0.6em] text-sm mb-4 block">
              Our Core Sectors
            </span>
            <h2 className="text-5xl md:text-7xl font-black mb-8 leading-[0.95] tracking-tighter">
              OPERATIONAL INTELLIGENCE ACROSS EVERY{" "}
              <span className="text-white/20">TIER.</span>
            </h2>
            <p className="text-xl text-white/50 leading-relaxed font-medium max-w-2xl">
              Specialized solutions for industries where every second and every
              asset counts. Powered by FleetNET proprietary AI architecture.
            </p>
          </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {industry.items.map((item) => (
                      <div
                        key={item}
                        className="flex items-center gap-3 text-xs uppercase tracking-[0.2em] font-bold text-white/40 group-hover:text-white/70 transition-colors"
                      >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
            <div className="max-w-2xl">
              ...
              <p className="text-white/50 font-medium text-lg">
                Expanding our technical infrastructure to support the next
                generation of mission-critical sectors.
              </p>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/50 mb-12 max-w-2xl font-medium">
              Consult with our systems architecture team to map FleetNET to your
              unique industry operational model.
            </p>

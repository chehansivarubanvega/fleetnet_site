    ...
    <main className="min-h-screen bg-[#050505] text-white selection:bg-primary/30 selection:text-white pb-0">
      ...
      <section className="relative z-10 pt-48 pb-32 overflow-hidden bg-[#050505]">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 right-0 w-full h-full bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:100px_100px] opacity-20" />
          <motion.div
            className="absolute top-1/4 -right-24 w-[35vw] h-[35vw] rounded-full bg-blue-600/20 blur-[160px]"
            animate={{ x: [0, -30, 0], y: [0, 30, 0] }}
            transition={{ duration: 15, repeat: Infinity, ease: 'easeInOut' }}
          />
          <motion.div
            className="absolute -bottom-20 -left-20 w-[30vw] h-[30vw] rounded-full bg-purple-600/15 blur-[160px]"
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            COMPLETE <span className="text-primary italic">CONTROL.</span><br />
          ...
          <motion.p
            ...
            className="mt-12 text-xl md:text-3xl text-white/50 max-w-4xl leading-tight font-medium mb-12"
          >
            Real-time map visibility, a live KPI dashboard, predictive maintenance scheduling, and granular driver performance analytics — all working seamlessly together.
          </motion.p>
          ...
          >
            <Link href="#" className="px-10 py-5 bg-white text-black font-black uppercase tracking-[0.2em] text-sm hover:bg-primary transition-colors rounded-full shadow-[0_0_30px_rgba(255,255,255,0.05)] inline-flex items-center gap-3">
              <Phone className="w-4 h-4" /> Request a Demo
            </Link>
            <Link href="#live-map" className="px-10 py-5 bg-transparent border-2 border-white/10 text-white font-black uppercase tracking-[0.2em] text-sm hover:border-white transition-all rounded-full inline-flex items-center gap-3">

    ...
    >
      ...
      >
        <div className="flex justify-between items-center gap-4 relative">
          ...
          <Link
            href="/"
            className="navbar-logo-container flex shrink-0 items-center transform-origin-left"
          >
          ...
          <div className="hidden lg:flex items-center shrink-0 space-x-3 xl:space-x-5">
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-2">
                ...
                <span className="uppercase tracking-[0.15em] text-[11px] xl:text-[12px] font-black text-white/90 group-hover:text-white transition-colors">
                  Fleet Console
                </span>
              </div>
